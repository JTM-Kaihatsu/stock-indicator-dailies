    ...
    setRows((prev) => {
      ...
      return [
        ...withoutDuplicate,
        {
          ...
          settings: settingsToSend ?? null, heldShares: 0, sinceDate: null, positionRisk: null, overallOverrideReason: null, unrealizedPnl: null,
        },
      ];
    });
  }
                          ...
                          <td colSpan={5}>
                            <div style={{ padding: '8px 0' }}>
                              ...
                              <div className="settings-group-hint" style={{ marginTop: 16, marginBottom: 4 }}>
                                Manage this ticker&apos;s individual buy/sell positions on its own page.
                              </div>
